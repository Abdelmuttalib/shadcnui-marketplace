...
import {
  ...
  TextareaDemo,
  ToggleGroupDemo,
} from "@/components/ui/material/showcase";
...
import { Tabs, TabsList, TabsTrigger } from "@/components/ui/material/ui/tabs";
        ...
        <div className="mt-12 -ml-[32rem] h-[46.375rem] origin-top select-none sm:-mt-20 sm:-ml-[24rem] sm:h-auto md:mt-10 md:-ml-64 lg:mt-0 lg:-ml-16 xl:-mr-4 xl:ml-0">
          <div className="flex justify-end">
            <div className="relative flex items-end">
              ...
              <div className="relative z-10 p-4">
                ...
                <div className="w-[24.5rem] divide-y divide-material-muted-foreground/20 rounded-material-lg bg-material-card text-[0.8125rem]/5 text-material-foreground shadow-xl shadow-black/5 border border-material-border">
          ...
          <div className="flex items-start justify-end">
              ...
              <div className="relative flex items-end justify-end">
                ...
                <div>
                  <div className="flex justify-end gap-2 items-center p-4">
                    <MenubarDemo />
                    <DrawerDemo />
                    {/* <div className="pointer-events-auto flex divide-x divide-material-muted-foreground/20 overflow-hidden rounded-md bg-material-card text-[0.8125rem]/5 font-medium text-muted-foreground shadow-xs border">
                        <div className="px-4 py-2 hover:bg-material-accent/50 hover:text-foreground">
                          Years
                        </div>
                        <div className="px-4 py-2 hover:bg-material-accent/50 hover:text-foreground">
                          Months
                ...
                <div className="relative z-10 p-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pointer-events-auto w-[21rem] rounded-material-lg bg-material-card p-4 shadow-xl shadow-black/5 border border-material-border">
                      <ContextMenuDemo />
                    </div>
                  </div>
                </div>
              ...
              <div className="flex items-start justify-end">
                <div className="relative p-4">
                  ...
                  <div className="pointer-events-auto w-[28.125rem] text-[0.8125rem]/5 text-muted-foreground flex justify-end gap-2">
                    ...
                    {/* <div className="mt-2 flex items-center justify-between rounded-md bg-material-card px-3 py-2 shadow-xs border">
                        Tom Cook
                    ...
                    {/* <div className="mt-4 overflow-hidden rounded-md bg-material-card py-1 shadow-xl shadow-black/5 border">
            ...
            <div className="relative z-10 p-4">
              ...
              {/* <div className="relative p-4">
                  <div className="-mr-[4.625rem] w-[30.25rem] rounded-md bg-material-card p-4 shadow-xl shadow-black/5 border">
