...
import { DataTable } from "@/registry/spectrum/ui/data-table";
import {
  Select,
  SelectContent,
  SelectGroup,
...
const columns = [
  ...
  },
  {
    ...
    cell: ({ cell }) => (
      <p className="text-spectrum-muted-foreground text-sm">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {data.overview.map((item) => (
            <div
              key={item.title}
              className="border-t-spectrum-input flex flex-col gap-3 border-t py-6"
            >
