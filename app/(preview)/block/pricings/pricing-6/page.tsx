...
const pricingTiers = [
  {
    ...
    icon: <Briefcase className="h-6 w-6 text-wedges-primary" />,
    features: [
  ...
  },
  {
    ...
    icon: <Rocket className="h-6 w-6 text-wedges-primary" />,
    highlighted: true,
    features: [
  ...
  },
  {
    ...
    icon: <Building className="h-6 w-6 text-wedges-primary" />,
    features: [
...
export default function PricingPage() {
  return (
    <div className="relative bg-gradient-to-b from-background via-accent/60 to-indigo-600/20">
      {/* Background Pattern */}
      <div className="absolute inset-0 -z-10 h-full w-full bg-wedges-background">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <Typography
            as="p"
            variant="xl/normal"
            className="mx-auto mt-6 max-w-xl text-wedges-muted-foreground"
          >
...
function PricingCard({
  ...
  return (
    <div className="h-full">
      ...
      >
        <CardHeader>
          <div className="mb-4 flex w-fit items-center rounded-md bg-wedges-primary/10 pr-4">
          ...
          <div className="mt-2 flex items-baseline">
            ...
            <Typography
              as="span"
              variant="sm/normal"
              className="ml-1 text-wedges-muted-foreground"
            >
              /month
            </Typography>
          </div>
          ...
          <ul className="mt-6 space-y-2">
            {features.map((feature, index) => (
              <li key={index} className="flex items-center text-sm">
                <span className="mr-2 rounded-md bg-wedges-primary/10 p-1.5">
                  <Check className="h-4 w-4 text-wedges-primary" />
                </span>
                {feature.text}
              </li>
            ))}
          ...
          <Button
            className={`w-full ${
              highlighted
                ...
                : "bg-wedges-secondary text-wedges-secondary-foreground hover:bg-wedges-secondary/90"
            }`}
