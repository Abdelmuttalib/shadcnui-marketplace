...
import { Card, CardContent, CardFooter } from "@/registry/wedges/ui/card";
...
export default function BlogSectionPage() {
  ...
  return (
    <main>
      <section className="bg-wedges-background py-24 sm:py-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            ...
            <div className="mx-auto h-1 w-24 bg-wedges-primary" />
            <Typography
              as="h2"
              variant="xl/normal"
              className="mx-auto mt-6 max-w-2xl text-wedges-muted-foreground"
            >
    ...
    <Card className="group relative overflow-hidden transition-all duration-300 hover:shadow-lg">
      <Link href={`/blog/${slug}`} className="block overflow-hidden">
        <div className="relative h-64 w-full overflow-hidden">
          ...
          <span className="absolute bottom-4 left-4 rounded-full border bg-card px-3 py-1 text-sm font-medium text-wedges-foreground">
            {category}
          </span>
        </div>
      </Link>
      <CardContent className="p-6">
        ...
        <Typography
          as="p"
          variant="sm/normal"
          className="mb-4 line-clamp-2 text-wedges-muted-foreground"
        >
          {excerpt}
        </Typography>
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div className="text-sm">
              ...
              <div className="flex items-center text-xs text-wedges-muted-foreground">
      ...
      <CardFooter className="border-t p-6">
        <Link
          href={`#`}
          className="group inline-flex items-center text-sm font-medium text-wedges-primary transition-colors hover:text-wedges-primary/80"
        >
          Read Article
