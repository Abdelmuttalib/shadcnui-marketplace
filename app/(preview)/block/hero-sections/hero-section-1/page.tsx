      ...
      <nav className="fixed left-0 right-0 top-0 z-50">
        <div className="container mx-auto flex items-center justify-between px-4 py-4">
          <Link href="#" className="flex items-center space-x-2">
            <span className="text-xl font-medium text-wedges-foreground">
              Acme Inc
            </span>
          </Link>
        ...
        <div className="container col-span-2 mx-auto pt-32 lg:col-span-1 lg:max-w-xl">
          <div className="space-y-6 px-4 py-16">
            ...
            <Typography
              as="h1"
              variant="xl/normal"
              className="text-wedges-foreground/80"
            >
            ...
            <ul className="space-y-3 text-sm text-wedges-muted-foreground">
              {[
                "Advanced Analytics",
                "Team Collaboration",
                "Custom Integrations",
