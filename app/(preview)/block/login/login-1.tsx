    ...
    >
      ...
      <a
        ...
        className={`font-medium hover:underline ${
          variant === "glass" ? "text-white" : "text-wedges-primary"
        }`}
      >
        Sign up
      </a>
  ...
  <div className="flex min-h-screen items-center justify-center bg-gray-100">
    ...
    <Card className="w-full max-w-lg shadow-xl">
      <CardHeader className="flex flex-col items-center space-y-1">
        <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-wedges-primary">
      ...
      <CardFooter className="flex flex-col space-y-4">
        ...
        <div className="space-x-4 text-center text-sm text-gray-500">
          <a href="#" className="text-wedges-primary hover:underline">
            Forgot password?
          </a>
          <span>|</span>
          <a href="#" className="text-wedges-primary hover:underline">
