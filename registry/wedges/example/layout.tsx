...
export default function ExamplesLayout({ children }: ExamplesLayoutProps) {
  return (
    ...
    //   <header className="sticky top-0 z-20 flex h-16 items-center border-b bg-wedges-background/[0.7] backdrop-blur-xs">
    //     <nav className="container mx-auto flex items-center justify-between gap-2">
    //       <div className="flex items-center gap-2">
    //         <Link
    //           href="/"
    //           className="rounded-wedges-md bg-wedges-accent/60 px-2 py-0.5 text-xl font-medium text-wedges-foreground"
    //         >
    //           shadcn <span className="italic text-primary-500">styles</span>
    //         </Link>
    //       </div>
    //       <div className="flex items-center gap-6 text-sm">
    //         <Link href="/dashboard" className="text-wedges-muted-foreground">
    //           Dashboard
    //         </Link>
    //         <Link href="/dashboard" className="text-wedges-muted-foreground">
    //           Dashboard
    ...
    //           as="p"
    //           variant="lg/normal"
    //           className="px-4 text-wedges-muted-foreground"
    //         >
    ...
    //       <div className="mx-4 overflow-hidden rounded-[0.5rem] border border-y border-border/80 bg-wedges-background shadow-sm">
    //         {children}
    //       </div>
    //     </section>
    //     <div className="min-h-screen w-6 border-x bg-[image:repeating-linear-gradient(315deg,oklch(var(--border))_0,_oklch(var(--border))_1px,_transparent_0,_transparent_50%)] bg-[size:10px_10px] bg-fixed md:w-8 lg:w-12" />
