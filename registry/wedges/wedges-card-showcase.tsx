...
export function WedgesCardShowcase() {
  return (
    <div>
      <Card>
        <CardHeader>
          <div className="flex items-start justify-between">
            ...
            <div className="flex items-center gap-1 rounded-wedges-md bg-wedges-secondary text-wedges-secondary-foreground">
        ...
        <CardContent className="space-y-4">
          <div className="flex flex-wrap gap-2 text-sm text-wedges-muted-foreground">
            <div className="flex items-center gap-1.5 rounded-wedges-md border border-wedges-input/60 bg-wedges-muted p-1 px-2 text-sm">
              <span>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div className="flex -space-x-2">
                <Avatar className="h-6 w-6 border-2 border-wedges-background">
            ...
            <div className="flex items-center gap-1 text-sm text-wedges-muted-foreground">
              <Calendar className="h-3.5 w-3.5" />
              <span>Updated April 2023</span>
            </div>
          </div>
        </CardContent>
        <CardFooter className="flex items-center justify-between border-t border-t-wedges-border pt-4">
          <div className="flex items-center gap-2">
            <TooltipProvider>
              <Tooltip>
