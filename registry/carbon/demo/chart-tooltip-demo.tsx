...
export default function Component() {
  return (
    <div className="grid aspect-video w-full max-w-md justify-center text-cb-foreground md:grid-cols-2 [&>div]:relative [&>div]:flex [&>div]:h-[137px] [&>div]:w-[224px] [&>div]:items-center [&>div]:justify-center [&>div]:p-4">
      <div>
        ...
        {payload.map((item, index) => {
          ...
          return (
            <div
              key={index}
              className={cn(
                "flex w-full items-stretch gap-2 [&>svg]:h-2.5 [&>svg]:w-2.5 [&>svg]:text-cb-muted-foreground",
            ...
            >
              <>
                ...
                >
                  ...
                  <span className="font-mono font-medium tabular-nums text-cb-foreground">
