...
export function PodcastEmptyPlaceholder() {
  return (
    <div className="flex h-[450px] shrink-0 items-center justify-center rounded-cb-md border border-dashed">
      <div className="mx-auto flex max-w-[420px] flex-col items-center justify-center text-center">
        <svg
          ...
          strokeWidth="2"
          className="h-10 w-10 text-cb-muted-foreground"
          viewBox="0 0 24 24"
        >
        ...
        <p className="mb-4 mt-2 text-sm text-cb-muted-foreground">
