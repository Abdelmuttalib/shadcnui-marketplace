      ...
      <SidebarProvider>
        ...
        <PageContainer size={"full"} className="border-b">
          <div className="flex items-center justify-between py-2">
                ...
                <div className="flex items-center justify-between pb-6">
                  <div>
                    ...
                    <Typography
                      as={"p"}
                      variant="md/normal"
                      className="max-w-4xl text-libelle-muted-foreground"
                    >
            ...
            <div className="border-b border-libelle-border pb-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <div className="relative">
                      <Search className="absolute left-2.5 top-[18px] size-4 -translate-y-1/2 text-libelle-muted-foreground" />
                      <Input
                        type="search"
                        placeholder="Search..."
                    ...
                    <div key={status.title} className="flex-1 space-y-2">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          ...
                          <Badge
                            variant="secondary"
                            className="rounded-libelle-sm px-1.5"
                          >
                            {
                              tasks.filter(
