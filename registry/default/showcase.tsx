...
export function AspectRatioDemo() {
  return (
    <AspectRatio ratio={16 / 9} className="bg-dft-muted">
      <Image
...
export function ContextMenuDemo() {
  return (
    <ContextMenu>
      <ContextMenuTrigger className="flex h-[150px] w-[300px] items-center justify-center rounded-dft-md border border-dashed border-dft-border text-sm">
        Right click here
      </ContextMenuTrigger>
