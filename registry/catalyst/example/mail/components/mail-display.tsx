          ...
          <Tooltip>
            <Popover>
              ...
              <PopoverContent className="flex w-[535px] p-0">
                <div className="flex flex-col gap-2 border-r border-r-catalyst-border px-2 py-4">
      ...
      {mail ? (
        <div className="flex flex-1 flex-col">
          <div className="flex items-start p-4">
            ...
            {mail.date && (
              <div className="ml-auto text-xs text-catalyst-muted-foreground">
        ...
        <div className="p-8 text-center text-catalyst-muted-foreground">
          No message selected
        </div>
      )}
    </div>
