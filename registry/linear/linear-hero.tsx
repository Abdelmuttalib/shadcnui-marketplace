      ...
      <div className="-ml-[32rem] mt-12 h-[46.375rem] origin-top select-none sm:-ml-[24rem] sm:-mt-20 sm:h-auto md:-ml-64 md:mt-10 lg:-ml-16 lg:mt-0 xl:-mr-4 xl:ml-0">
        <div className="flex justify-end">
          <div className="relative flex items-end">
            ...
            <div className="relative z-10 p-4">
              ...
              <div className="w-[24.5rem] divide-y divide-linear-muted-foreground/20 rounded-linear-lg border border-linear-input bg-linear-card text-[0.8125rem]/5 text-linear-foreground shadow-xl shadow-black/5">
          ...
          <div className="relative z-10 p-4">
            ...
            <div className="flex w-fit items-center gap-2">
              ...
              {/* <div className="flex items-center space-x-4 px-6 py-4">
                  ...
                  <div className="flex flex-auto items-center border-l border-slate-200/60 pr-4 pl-6 text-[0.8125rem]/5 text-linear-muted-foreground">
                    <div>00:51</div>
        ...
        <div className="flex items-start justify-end">
          <div>
            <div className="relative flex items-end justify-end">
              ...
              <div>
                ...
                <div className="flex items-center justify-end gap-2 p-4 pt-0">
                  ...
                  {/* <div className="pointer-events-auto flex divide-x divide-linear-muted-foreground/20 overflow-hidden rounded-linear-md bg-card text-[0.8125rem]/5 font-medium text-linear-muted-foreground shadow-xs border">
              ...
              <div className="relative z-10 p-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="pointer-events-auto w-[21rem] rounded-linear-lg border border-linear-input bg-linear-card p-4 shadow-xl shadow-black/5">
                    <ContextMenuDemo />
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-start justify-end">
              <div className="relative p-4">
                ...
                <div className="pointer-events-auto flex w-[28.125rem] justify-end gap-2 text-[0.8125rem]/5 text-linear-muted-foreground">
                  {/* <div className="mt-2 flex items-center justify-between rounded-linear-md bg-card px-3 py-2 shadow-xs border">
                        Tom Cook
                  ...
                  {/* <div className="mt-4 overflow-hidden rounded-linear-md bg-card py-1 shadow-xl shadow-black/5 border">
                ...
                <div className="relative w-full rounded-linear-md p-4">
                  <div className="pointer-events-auto space-y-1 rounded-linear-lg text-sm font-medium text-linear-muted-foreground shadow-xl shadow-black/5">
                    <AccordionDemo />
                  </div>
                </div>
              </div>
          ...
          <div className="relative z-10 p-4">
            ...
            {/* <div className="relative p-4">
                  <div className="-mr-[4.625rem] w-[30.25rem] rounded-linear-md bg-card p-4 shadow-xl shadow-black/5 border">
