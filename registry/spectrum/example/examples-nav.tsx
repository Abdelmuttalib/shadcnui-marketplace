        ...
        >
          {examples.map((example, index) => (
            <Link
              ...
              key={example.href}
              className={cn(
                "flex h-7 items-center justify-center rounded-spctm-md px-4 text-center text-sm transition-colors hover:bg-spctm-accent/80 hover:text-spctm-ring",
                pathname?.startsWith(example.href) ||
                  (index === 0 && pathname === "/")
                  ? "bg-spctm-accent font-medium text-ring"
