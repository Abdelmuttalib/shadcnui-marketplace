...
export function MoonCardShowcase() {
  return (
    <div>
      <Card>
        <CardHeader>
          <div className="flex items-start justify-between">
            ...
            <div className="flex items-center gap-1 rounded-moon-md bg-moon-secondary text-moon-secondary-foreground">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div className="flex -space-x-2">
                <Avatar className="h-6 w-6 border-2 border-moon-background">
            ...
            <div className="flex items-center gap-1 text-sm text-moon-muted-foreground">
              <Calendar className="h-3.5 w-3.5" />
              <span>Updated April 2023</span>
            </div>
          </div>
        </CardContent>
        <CardFooter className="flex items-center justify-between border-t border-t-moon-border pt-4">
          <div className="flex items-center gap-2">
            <TooltipProvider>
              <Tooltip>
