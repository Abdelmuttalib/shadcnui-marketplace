        ...
        >
          <CardHeader className="space-y-0 pb-2">
            ...
            <CardTitle className="text-4xl tabular-nums">
              12,584{" "}
              <span className="font-sans text-sm font-normal tracking-normal text-material-muted-foreground">
                steps
              </span>
            </CardTitle>
          </CardHeader>
          ...
          <CardFooter className="flex-col items-start gap-1">
            <CardDescription>
              ...
              <span className="font-medium text-material-foreground">
                53,305
              </span>{" "}
              steps.
            </CardDescription>
          ...
          <CardHeader className="flex flex-row items-center gap-4 space-y-0 pb-2 [&>div]:flex-1">
            <div>
              ...
              <CardTitle className="flex items-baseline gap-1 text-4xl tabular-nums">
                62
                <span className="text-sm font-normal tracking-normal text-material-muted-foreground">
                  bpm
                </span>
              </CardTitle>
            </div>
          ...
          <CardContent className="grid gap-4">
            <div className="grid auto-rows-min gap-2">
              <div className="flex items-baseline gap-1 text-2xl font-bold tabular-nums leading-none">
                12,453
                <span className="text-sm font-normal text-material-muted-foreground">
                  steps/day
                </span>
              </div>
              <ChartContainer
        ...
        >
          <CardContent className="flex gap-4 p-4">
            <div className="grid items-center gap-2">
              <div className="grid flex-1 auto-rows-min gap-0.5">
                <div className="text-sm text-material-muted-foreground">
                  Move
                </div>
            ...
            >
              ...
              >
                ...
                <ChartTooltip
                  ...
                  formatter={(value) => (
                    <div className="flex min-w-[120px] items-center text-xs text-material-muted-foreground">
                      Time in bed
                      <div className="ml-auto flex items-baseline gap-0.5 font-mono font-medium tabular-nums text-material-foreground">
                        {value}
                        <span className="font-normal text-material-muted-foreground">
                          hr
                        </span>
                      </div>
                    </div>
