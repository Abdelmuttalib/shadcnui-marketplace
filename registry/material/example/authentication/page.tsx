  ...
  return (
    <>
      <div className="container relative mx-auto grid h-full min-h-screen grid-cols-1 flex-col items-center justify-center lg:max-w-none lg:grid-cols-2 lg:px-0">
        ...
        <div className="relative hidden h-full flex-col bg-material-muted p-10 text-white dark:border-r lg:flex">
        ...
        <div className="p-8">
          <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-96">
            ...
            <UserAuthForm />
            <p className="px-8 text-center text-sm text-material-muted-foreground">
