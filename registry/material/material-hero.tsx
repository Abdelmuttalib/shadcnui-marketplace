...
import { DemoDatePicker } from "@/registry/material/example/cards/components/date-picker";
import {
  ComboboxDemo,
  ContextMenuDemo,
  DrawerDemo,
      ...
      <div className="-ml-[32rem] h-[46.375rem] origin-top select-none sm:-ml-[24rem] sm:-mt-16 sm:h-auto md:-ml-64  lg:-ml-16 lg:mt-0 xl:-mr-4 xl:ml-0">
            ...
            <div className="relative z-10 p-4">
              ...
              <div className="absolute bottom-full left-40 -mb-px flex h-8 items-end overflow-hidden">
                <div className="-mb-px flex h-[2px] w-56">
                  <div className="blur-xs w-full flex-none [background-image:linear-gradient(90deg,rgba(56,189,248,0)_0%,#0EA5E9_32.29%,oklch(var(--material-primary))_67.19%,rgba(236,72,153,0)_100%)]"></div>
                  <div className="-ml-[100%] w-full flex-none blur-[1px] [background-image:linear-gradient(90deg,rgba(56,189,248,0)_0%,#0EA5E9_32.29%,rgba(236,72,153,0.3)_67.19%,rgba(236,72,153,0)_100%)]"></div>
                </div>
              </div>
              <div className="w-[24.5rem] divide-y divide-muted-foreground/20 rounded-material-lg border border-material-input bg-material-card text-[0.8125rem]/5 text-material-foreground shadow-xl shadow-black/5">
                <div className="flex items-center p-4">
                  <Avatar className="size-10 flex-none rounded-full">
                    <AvatarImage
                      src={`https://avatar.vercel.sh/material-avatar-1`}
                      alt="avatar"
                    />
                  ...
                  <div className="ml-4 flex-auto">
                    ...
                    <div className="mt-1 text-material-muted-foreground">
                      @leonardkrasner
                    </div>
                  </div>
                ...
                <div className="flex items-center p-4">
                  <Avatar className="size-10 flex-none rounded-full">
                    <AvatarImage
                      src={`https://avatar.vercel.sh/material-avatar-2`}
                      alt="avatar"
                    />
                ...
                <div className="flex items-center p-4">
                  <Avatar className="size-10 flex-none rounded-full">
                    <AvatarImage
                      src={`https://avatar.vercel.sh/material-avatar-3`}
                      alt="avatar"
                    />
        ...
        <div className="flex items-start justify-end">
          <div>
            <div className="relative flex items-end justify-end">
              ...
              <div>
                ...
                <div className="relative z-10 p-4">
                  ...
                  <div className="absolute bottom-full left-16 -mb-px flex h-8 items-end overflow-hidden">
                    <div className="-mb-px flex h-[2px] w-56">
                      <div className="blur-xs w-full flex-none [background-image:linear-gradient(90deg,rgba(56,189,248,0)_0%,#0EA5E9_32.29%,oklch(var(--material-primary))_67.19%,rgba(236,72,153,0)_100%)]"></div>
                      <div className="-ml-[100%] w-full flex-none blur-[1px] [background-image:linear-gradient(90deg,rgba(56,189,248,0)_0%,#0EA5E9_32.29%,oklch(var(--material-primary))_67.19%,rgba(236,72,153,0)_100%)]"></div>
                    </div>
                  </div>
              ...
              <div className="relative z-10 p-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-material-lg border border-material-input bg-material-card p-4 shadow-xl shadow-black/5">
                    <ContextMenuDemo />
                  </div>
                  {/* <DemoDatePicker /> */}

                  {/* <div className="pointer-events-auto flex w-[21rem] flex-col gap-4 rounded-material-lg border border-material-input bg-material-card p-4 shadow-xl shadow-black/5">
            ...
            <div className="flex items-start justify-end">
              <div className="relative p-4">
                ...
                <DemoDatePicker />
                {/* <DemoNotifications /> */}
                {/* <div className="pointer-events-auto relative flex w-[28.125rem] justify-end gap-2 rounded-md p-4 text-[0.8125rem]/5 text-material-muted-foreground">
                  <div className="pointer-events-auto space-y-1 rounded-lg text-sm font-medium text-material-muted-foreground shadow-xl shadow-black/5">
                    <AccordionDemo />
                  </div>
                </div> */}
              </div>
          ...
          <div className="relative z-10 w-[32.125rem] p-4">
            ...
            {renderStyleCardShowcase("material")}
          </div>
        </div>
      </div>
    </>
