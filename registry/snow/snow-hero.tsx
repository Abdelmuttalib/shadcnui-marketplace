...
import {
  ...
  TextareaDemo,
  ToggleGroupDemo,
} from "@/registry/snow/showcase";
import { Badge } from "@/registry/snow/ui/badge";
import { Button } from "@/registry/snow/ui/button";
import { Checkbox } from "@/registry/snow/ui/checkbox";
import { Switch } from "@/registry/snow/ui/switch";
import { Tabs, TabsList, TabsTrigger } from "@/registry/snow/ui/tabs";
import { Toggle } from "@/registry/snow/ui/toggle";

export function SnowUI() {
  return (
    <>
      {/* pointer-events-none  */}
      ...
      <div className="-ml-[32rem] mt-12 h-[46.375rem] origin-top select-none sm:-ml-[24rem] sm:-mt-20 sm:h-auto md:-ml-64 md:mt-10 lg:-ml-16 lg:mt-0 xl:-mr-4 xl:ml-0">
        <div className="flex justify-end">
          <div className="relative flex items-end">
            <div className="absolute -inset-x-8 bottom-0 h-px bg-snow-foreground/10 [mask-image:snow-gradient(to_right,transparent,white_4rem,white_calc(100%-4rem),transparent)]"></div>
            <div className="absolute left-16 top-full -mt-px h-8 overflow-hidden">
              <div className="-mt-px flex h-[2px] w-56">
                <div className="blur-xs w-full flex-none [background-image:snow-gradient(90deg,rgba(56,189,248,0)_0%,#0EA5E9_32.29%,rgba(236,72,153,0.3)_67.19%,rgba(236,72,153,0)_100%)]"></div>
                <div className="-ml-[100%] w-full flex-none blur-[1px] [background-image:snow-gradient(90deg,rgba(56,189,248,0)_0%,#0EA5E9_32.29%,rgba(236,72,153,0.3)_67.19%,rgba(236,72,153,0)_100%)]"></div>
              </div>
            </div>
            <div>
              <div className="p-4">
              ...
              <div className="relative z-10 flex flex-col items-end gap-2 p-4 text-right">
                <div className="absolute -inset-y-8 right-0 w-px bg-snow-foreground/10 [mask-image:snow-gradient(to_top,transparent,white_4rem,white_calc(100%-4rem),transparent)]"></div>
                <div className="absolute -inset-y-8 left-0 w-px bg-snow-foreground/10 [mask-image:snow-gradient(to_top,transparent,white_4rem,white_calc(100%-4rem),transparent)]"></div>
                <div className="absolute -inset-x-8 bottom-0 h-px bg-snow-foreground/10 [mask-image:snow-gradient(to_left,transparent,white_4rem,white_calc(100%-4rem),transparent)]"></div>
                {/* <div className="absolute -inset-y-8 left-0 w-px bg-snow-foreground/10 [mask-image:snow-gradient(to_top,transparent,white_4rem,white_calc(100%-4rem),transparent)]"></div>
                    <div className="absolute -inset-x-8 top-0 h-px bg-snow-foreground/10 [mask-image:snow-gradient(to_left,transparent,white_4rem,white_calc(100%-4rem),transparent)]"></div>
                    <div className="absolute inset-0 -right-px bg-snow-to-br from-white/0 via-white/25 to-white/0"></div> */}
            ...
            <div className="relative z-10 p-4">
              ...
              <div className="w-[24.5rem] divide-y divide-snow-muted-foreground/20 rounded-snow-lg border border-snow-input bg-snow-card text-[0.8125rem]/5 text-snow-foreground shadow-xl shadow-black/5">
                <div className="flex items-center p-4">
                  ...
                  <div className="ml-4 flex-auto">
                    ...
                    <div className="mt-1 text-snow-muted-foreground">
                      @leonardkrasner
                    </div>
                  </div>
          ...
          <div className="relative z-10 p-4">
            ...
            <div className="flex w-fit items-center gap-2">
              ...
              {/* <div className="flex items-center space-x-4 px-6 py-4">
                  ...
                  <div className="flex flex-auto items-center border-l border-slate-200/60 pr-4 pl-6 text-[0.8125rem]/5 text-snow-muted-foreground">
                    <div>00:51</div>
        ...
        <div className="flex items-start justify-end">
          <div>
            <div className="relative flex items-end justify-end">
              ...
              <div>
                ...
                <div className="flex items-center justify-end gap-2 p-4 pt-0">
                  ...
                  {/* <div className="pointer-events-auto flex divide-x divide-snow-muted-foreground/20 overflow-hidden rounded-snow-md bg-card text-[0.8125rem]/5 font-medium text-snow-muted-foreground shadow-xs border">
              ...
              <div className="relative z-10 p-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="pointer-events-auto w-[21rem] rounded-snow-lg border border-snow-input bg-snow-card p-4 shadow-xl shadow-black/5">
                    <ContextMenuDemo />
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-start justify-end">
              <div className="relative p-4">
                ...
                <div className="pointer-events-auto flex w-[28.125rem] justify-end gap-2 text-[0.8125rem]/5 text-snow-muted-foreground">
                  {/* <div className="mt-2 flex items-center justify-between rounded-snow-md bg-card px-3 py-2 shadow-xs border">
                        Tom Cook
                  ...
                  {/* <div className="mt-4 overflow-hidden rounded-snow-md bg-card py-1 shadow-xl shadow-black/5 border">
                ...
                <div className="relative w-full rounded-snow-md p-4">
                  <div className="pointer-events-auto space-y-1 rounded-snow-lg text-sm font-medium text-snow-muted-foreground shadow-xl shadow-black/5">
                    <AccordionDemo />
                  </div>
                </div>
              </div>
          ...
          <div className="relative z-10 p-4">
            ...
            {/* <div className="relative p-4">
                  <div className="-mr-[4.625rem] w-[30.25rem] rounded-snow-md bg-card p-4 shadow-xl shadow-black/5 border">
