...
const inputVariants = cva(
  "relative text-lg border-0 transition-colors inline-flex items-center focus:outline-transparent transition duration-200 disabled:pointer-events-none disabled:opacity-60 disabled:hover:opacity-60 disabled:cursor-not-allowed disabled:shadow-none ring-1 ring-transparent ring-inset focus:ring-2 focus:ring-inset outline-none focus:outline-none w-full rounded focus:outline-transparent focus:ring-2 focus:ring-inset focus:outline-none disabled:bg-layer-3 disabled:hover:disabled:bg-background-muted/30 disabled:text-foreground-muted disabled:placeholder:text-foreground-muted",
  {
    variants: {
      variant: {
        default:
