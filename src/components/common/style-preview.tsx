...
import { getStylesPath2, useStyle } from "@/hooks/use-style";
...
export function StylePreview({
  ...
  return (
    <div className={cn("w-full max-w-[1440px]")} id={id}>
      ...
      <div
        className={cn(
          "relative mb-6 space-y-1 p-1 md:p-2",
          "overflow-hidden"
      ...
      >
        ...
        <div className="flex flex-col justify-between gap-2 overflow-x-auto rounded-2xl border bg-background p-2">
            ...
            {preview ? (
              ...
              >
                <iframe
                  ...
                  title={title}
                  className={cn(
                    "block h-full min-h-[45rem] w-full",
                    {
