...
export const CarbonStyleRegistryIndex = {
  ...
  "alert-dialog": {
    demo: dynamic(() => import("./example/alert-dialog-demo")),
    code: "",
    title: "Alert Dialog",
    description:
  ...
  avatar: {
    demo: dynamic(() => import("./example/avatar-demo")),
    code: "",
    title: "Avatar",
    description: "Avatars are used to represent users or objects.",
  },
  badge: {
    demo: dynamic(() => import("./example/badge-demo")),
    code: "",
    title: "Badge",
