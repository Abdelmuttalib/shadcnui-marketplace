...
import {
  ...
  AlertDialogTitle,
  AlertDialogTrigger,
} from "@/registry/catalyst/ui/alert-dialog";
...
import { AspectRatio } from "@/registry/catalyst/ui/aspect-ratio";
...
import {
  ...
  CarouselNext,
  CarouselPrevious,
} from "@/registry/catalyst/ui/carousel";
...
import {
  ...
  ContextMenuTrigger,
} from "@/registry/catalyst/ui/context-menu";

export function ContextMenuDemo() {
  return (
    <ContextMenu>
      <ContextMenuTrigger className="flex h-[150px] w-[300px] items-center justify-center rounded-md border border-dashed border-catalyst-border text-sm">
        Right click here
      </ContextMenuTrigger>
...
import {
  ...
  DrawerTitle,
  DrawerTrigger,
} from "@/registry/catalyst/ui/drawer";
...
import {
  ...
  MenubarSubTrigger,
  MenubarTrigger,
} from "@/registry/catalyst/ui/menubar";
...
import {
  ...
  ResizablePanel,
  ResizablePanelGroup,
} from "@/registry/catalyst/ui/resizable";
...
import { SelectGroup, SelectLabel } from "@/registry/catalyst/ui/select";
...
import { Skeleton } from "@/registry/catalyst/ui/skeleton";
...
import {
  ...
  ChartTooltip,
  ChartTooltipContent,
} from "@/registry/catalyst/ui/chart";
const chartData4 = [
  { month: "January", desktop: 186 },
  { month: "February", desktop: 305 },
  { month: "March", desktop: 237 },
