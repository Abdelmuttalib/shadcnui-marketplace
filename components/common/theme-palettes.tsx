...
export const themePalettes: ThemePalette = {
  "palette-1": {
    light: {
      ...
      card: "100% 0 0" /* oklch(100% 0 0) */,
      "card-foreground": "0.12 0.005 250" /* oklch(0.12 0.005 250) */,
      popover: "100% 0 0" /* oklch(100% 0 0) */,
      ...
      "sidebar-background": "100% 0 0" /* oklch(100% 0 0) */,
    ...
    dark: {
      ...
      foreground: "100% 0 0" /* oklch(100% 0 0) */,
      card: "0.26 0.007 250" /* oklch(0.26 0.007 250) */,
      "card-foreground": "100% 0 0" /* oklch(100% 0 0) */,
      popover: "0.26 0.007 250" /* oklch(0.26 0.007 250) */,
      "popover-foreground": "100% 0 0" /* oklch(100% 0 0) */,
      primary: "0.36 0.015 250" /* oklch(0.36 0.015 250) */,
      "primary-foreground": "100% 0 0" /* oklch(100% 0 0) */,
      secondary: "0.26 0.007 250" /* oklch(0.26 0.007 250) */,
      "secondary-foreground": "100% 0 0" /* oklch(100% 0 0) */,
      ...
      "accent-foreground": "100% 0 0" /* oklch(100% 0 0) */,
      destructive: "56.92% 0.21 25.92" /* oklch(56.92% 0.21 25.92) */,
      "destructive-foreground": "100% 0 0" /* oklch(100% 0 0) */,
      ...
      "sidebar-accent-foreground": "100% 0 0",
  ...
  "palette-2": {
    ...
    dark: {
      ...
      "sidebar-background": "0.12 0.005 250" /* oklch(0.12 0.005 250) */,
      "sidebar-foreground": "100% 0 0" /* oklch(100% 0 0) */,
      "sidebar-primary":
        "44.93% 0.0493 217.02" /* oklch(44.93% 0.0493 217.02) */,
      "sidebar-primary-foreground": "100% 0 0" /* oklch(100% 0 0) */,
      "sidebar-accent": "0.19 0.007 285" /* oklch(0.13 0.007 285) */,
      "sidebar-accent-foreground": "100% 0 0" /* oklch(100% 0 0) */,
  ...
  "palette-4": {
    ...
    dark: {
      ...
      "destructive-foreground": "0% 0.0099 269.97" /* oklch(100% 0 0) */,
  ...
  "palette-5": {
    ...
    dark: {
      ...
      foreground: "100% 0.0099 269.97" /* oklch(100% 0 0) */,
      card: "24% 0.0099 269.97" /* oklch(24% 0 0) */,
      "card-foreground": "100% 0.0099 269.97" /* oklch(100% 0 0) */,
      popover: "24% 0.0099 269.97" /* oklch(24% 0 0) */,
      "popover-foreground": "100% 0.0099 269.97" /* oklch(100% 0 0) */,
      ...
      "secondary-foreground": "100% 0.0099 269.97" /* oklch(100% 0 0) */,
      ...
      "accent-foreground": "100% 0.0099 269.97" /* oklch(100% 0 0) */,
      ...
      "sidebar-accent-foreground": "100% 0.0099 269.97" /* oklch(100% 0 0) */,
  ...
  "palette-7": {
    ...
    */
    light: {
      ...
      "secondary-foreground": "100% 0 0" /* oklch(0% 0 0) */,
  ...
  "palette-8": {
    ...
    */
    ...
    dark: {
      ...
      card: "0.22 0.041 237.32" /* oklch(0.22 0.041 237.32) */,
      "card-foreground": "100% 0 0" /* oklch(100% 0 0) */,
      popover: "0.22 0.041 237.32" /* oklch(0.22 0.041 237.32) */,
      "popover-foreground": "100% 0 0" /* oklch(100% 0 0) */,
      primary: "0.59 0.1814 16.77" /* oklch(0.59 0.1814 16.77) */,
      "primary-foreground": "100% 0 0" /* oklch(100% 0 0) */,
  ...
  // oklch(0.66 0.1799 267.55) #6289ff
};

export const themePalettesListEntries = Object.entries(themePalettes);

const RADIUS_OPTIONS_VALUES: ThemeRadius[] = [
  "0rem",
  "0.1rem",
  "0.2rem",
  "0.3rem",
...
const DEFAULT_STYLES_RADIUS: Record<Style, string> = {
  carbon: "0rem",
  catalyst: "0.6rem",
  wedges: "0.5rem",
  snow: "0.4rem",
...
export function getStyleDefaultRadius(style: Style) {
  return DEFAULT_STYLES_RADIUS[style] || "0.5rem";
}

interface ThemePalettePreviewProps {
  palette: ThemePalette["palette-1"];
  size?: number;
}
...
function ThemeRadiusSelect() {
  const { theme, setTheme } = useTheme();

  // const { selectedRadius, setSelectedRadius, onResetRadius } =
  //   useThemePalette();

  const { activePalette, setActivePalette, onResetPalette } =
    ...
    <div>
      <Select value={activePalette} onValueChange={setActivePalette}>
        ...
        <SelectContent className="w-full">
          {RADIUS_OPTIONS_VALUES.map((radius) => (
            <SelectItem key={radius} className={``} value={radius}>
...

{
  /* <span className="flex items-center gap-2">
                ...
                <span className="mr-2 flex font-medium capitalize">
                  {mainColors.map((color, index) => (
                    <span
                      key={`theme-palette-${selectedPalette}`}
                      className={cn(
                      ...
                      style={{
                        backgroundColor: `oklch(${
                          themePalettes[selectedPalette][theme || "light"][
...
export function ThemePaletteSelect() {
  ...
  // const { selectedPalette, setSelectedPalette, onResetPalette } =
  //   useThemePalette();
...
function ThemePalettePreview({ palette, size = 56 }: ThemePalettePreviewProps) {
    ...
    <div className="flex flex-col gap-2">
      <div className="flex flex-col gap-1">
        <div className="flex rounded-sm">
          {mainColors.map((color, index) => (
            <div
              key={`theme-palette-${color}`}
              className={cn("size-6 rounded-full border border-foreground/15", {
                // "rounded-full": index === 0,
                "-ml-2": index > 0,
                // "rounded-r-sm": index === mainColors.length - 1,
              })}
      ...
      {/* <div className="flex flex-col gap-1">
        <h3 className="text-xs font-medium">Light</h3>
        <div className="flex rounded-sm border">
          {mainColors.map((color, index) => (
            <div
              key={`light-${color}`}
              ...
              style={{
                backgroundColor: `oklch(${
                  palette.light[color as ThemePaletteVariableKey]
                })`,
              }}
              title={`Light ${color}`}
            />
      ...
      <div className="flex flex-col gap-1">
        <h3 className="text-xs font-medium">Dark</h3>
        <div className="flex rounded-sm border">
          {mainColors.map((color, index) => (
            <div
              key={`dark-${color}`}
              ...
              style={{
                backgroundColor: `oklch(${
                  palette.dark[color as ThemePaletteVariableKey]
                })`,
              }}
              title={`Dark ${color}`}
            />
...
export function ThemePaletteSelector({}: ThemePaletteSelectorProps) {
  // const [selectedPalette, setSelectedPalette] = React.useState(value);

  function onPaletteChange(paletteName: ThemePaletteName) {
  ...
  return (
    <div className="space-y-4">
      {/* <h3 className="text-md font-medium">Select Theme Palette</h3> */}
      ...
      {/* <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-2">
        {themePalettesListEntries.map(([paletteName, palette]) => (
          <div
            key={paletteName}
            className={`cursor-pointer rounded-lg border bg-background p-4 transition-all ${
            ...
            onClick={() => {
              console.log(
                "clicked",
                themePalettes[paletteName as ThemePaletteName]
              );
              setSelectedPalette(paletteName as ThemePaletteName);
            }}
          >
            <div className="mb-2 flex items-center justify-between">
              ...
              {selectedPalette === paletteName && (
                <RichBadge className="p-0.5 text-xs">
                  <CheckIcon className="size-3.5" />
                </RichBadge>
              )}
            </div>
            <ThemePalettePreview palette={palette} size={16} />
          </div>
        ))}
      </div>
      <div>
        <h3 className="text-md font-medium">Select Radius</h3>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {RADIUS_OPTIONS_VALUES.map((radius) => (
            <div
              key={radius}
              className={`cursor-pointer rounded-md border bg-accent p-2 px-2 text-center text-sm ${
